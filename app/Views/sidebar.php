...
$all_invoice_url = "/point_of_sale/pos/all_invoices";
$active = "active";
$menu_open = "menu-open";
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <!-- invoices -->
                <li class="nav-item <?php if ($current_url == $all_invoice_url){echo $menu_open;}?>">
                    <a href="#" class="nav-link <?php if ($current_url == $all_invoice_url){echo $active;}?>">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo site_url('pos/all_invoices') ?>" class="nav-link <?php if ($current_url == $all_invoice_url){echo $active;}?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>All Invoices</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?php echo site_url('pos/all_quotes') ?>" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>New Quote</p>
                            </a>
                        </li>
                ...
                <!-- category -->
                <li class="nav-item">
                    <a href="<?php echo site_url('pos/all_categories') ?>" class="nav-link">
